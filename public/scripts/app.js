...
$(document).ready(function() {
  const modalClose = document.getElementById('modal'); // Replace 'yourModalId' with the ID of your modal element
  ...
  $("#userInteraction").submit(function (event) {
    ...
    const ajaxRequest = $.ajax({
      ...
      $(".container").slideUp(function () {
        ...
        $(
          "#userInteraction "
        ).prepend(`      <ul class="flex-outer initial-outer" id="flex-outer">
